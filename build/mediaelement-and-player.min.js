...
a.container;b.bind(mejs.MediaFeatures.fullScreenEventName,function(){if(mejs.MediaFeatures.isFullScreen()){a.isNativeFullScreen=true;a.setControlsSize()}else{a.isNativeFullScreen=false;a.exitFullScreen()}})}var d=this,g=f('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="'+d.id+'" aria-live="polite"><span class="visuallyhidden">'+d.options.fullscreenText+"</span></button></div>").appendTo(c);d.container.parent().on("focus","button.guard",function(){g.trigger("click")});
if(d.media.pluginType==="native"||!d.options.usePluginFullScreen&&!mejs.MediaFeatures.isFirefox)g.click(function(){if(mejs.MediaFeatures.hasTrueNativeFullScreen&&mejs.MediaFeatures.isFullScreen()||a.isFullScreen){a.exitFullScreen();d.container.parent().find("button.guard").remove()}else{a.enterFullScreen();d.container.before('<button class="guard visuallyhidden">Quitter le mode plein \u00e9cran</button>');d.container.after('<button class="guard visuallyhidden">Quitter le mode plein \u00e9cran</button>')}});
