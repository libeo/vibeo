...
a.container.addClass((b.isAndroid?"mejs-android ":"")+(b.isiOS?"mejs-ios ":"")+(b.isiPad?"mejs-ipad ":"")+(b.isiPhone?"mejs-iphone ":"")+(a.isVideo?"mejs-video ":"mejs-audio "));if(b.isiOS){b=a.$media.clone();a.container.find(".mejs-mediaelement").append(b);a.$media.remove();a.$node=a.$media=b;a.node=a.media=b[0]}else a.container.find(".mejs-mediaelement").append(a.$media);setTimeout(function(){var d=a.container.find("video");d.attr("tabindex")==0&&d.removeAttr("tabindex")},200);a.controls=a.container.find(".mejs-controls");
a.layers=a.container.find(".mejs-layers");b=a.isVideo?"video":"audio";e=b.substring(0,1).toUpperCase()+b.substring(1);a.width=a.options[b+"Width"]>0||a.options[b+"Width"].toString().indexOf("%")>-1?a.options[b+"Width"]:a.media.style.width!==""&&a.media.style.width!==null?a.media.style.width:a.media.getAttribute("width")!==null?a.$media.attr("width"):a.options["default"+e+"Width"];a.height=a.options[b+"Height"]>0||a.options[b+"Height"].toString().indexOf("%")>-1?a.options[b+"Height"]:a.media.style.height!==
""&&a.media.style.height!==null?a.media.style.height:a.$media[0].getAttribute("height")!==null?a.$media.attr("height"):a.options["default"+e+"Height"];a.setPlayerSize(a.width,a.height);c.pluginWidth=a.height;c.pluginHeight=a.width}popuptooltip=function(){f(".bubble-text").show("fast");f(".bubble-text").css("display","block")};hidetooltip=function(){f(".bubble-text").hide("fast")};f(".mejs-tooltip").mouseenter(popuptooltip);f(".mejs-tooltip").focusin(popuptooltip);f(".mejs-tooltip").mouseleave(hidetooltip);
f(".mejs-tooltip").focusout(hidetooltip);mejs.MediaElement(a.$media[0],c)},showControls:function(a){var b=this;a=typeof a=="undefined"||a;if(!b.controlsAreVisible){if(a){b.controls.css("visibility","visible").stop(true,true).fadeIn(200,function(){b.controlsAreVisible=true});b.container.find(".mejs-control").css("visibility","visible").stop(true,true).fadeIn(200,function(){b.controlsAreVisible=true})}else{b.controls.css("visibility","visible").css("display","block");b.container.find(".mejs-control").css("visibility",
...
else c.controlsEnabled&&c.showControls(false)});else{(c.media.pluginType=="native"?c.$media:f(c.media.pluginElement)).click(function(){a.paused?a.play():a.pause()});c.container.bind("mouseenter mouseover",function(){if(c.controlsEnabled)if(!c.options.alwaysShowControls){c.killControlsTimer("enter");c.showControls()}}).bind("mousemove",function(){if(c.controlsEnabled){c.controlsAreVisible||c.showControls();c.options.alwaysShowControls||c.startControlsTimer(2500)}}).bind("mouseleave focusout",function(){c.controlsEnabled&&
...
false);e.addEventListener("error",function(){d.hide();b.find(".mejs-time-buffering").hide();g.show();g.find("mejs-overlay-error").html("Error loading this resource")},false)}},buildkeyboard:function(a,b,c,e){f(document).keydown(function(d){if(a.hasFocus&&a.options.enableKeyboard)for(var g=0,j=a.options.keyActions.length;g<j;g++)for(var i=a.options.keyActions[g],l=0,m=i.keys.length;l<m;l++)if(d.keyCode==i.keys[l]){d.preventDefault();i.action(a,e,d.keyCode);return false}return true});f(document).click(function(d){if(f(d.target).closest(".mejs-container").length==
...
i=b.find(".mejs-time-handle"),l=i.find(".mejs-time-handle-rewind"),m=i.find(".mejs-time-handle-forward"),o=b.find(".mejs-time-float"),r=b.find(".mejs-time-float-current"),t=function(h){h=h.pageX;var n=g.offset(),q=g.outerWidth(),s=0;s=0;var u=h-n.left;if(h>n.left&&h<=q+n.left&&e.duration){s=(h-n.left)/q;s=s<=0.02?0:s*e.duration;k&&e.setCurrentTime(s);if(!mejs.MediaFeatures.hasTouch){o.css("left",u);r.html(mejs.Utility.secondsToTimeCode(s));o.show()}}},k=false,p=false;g.bind("mousedown",function(h){if(h.which===
...
d.container.parent().on("focus","button.guard",function(){(mejs.MediaFeatures.hasTrueNativeFullScreen&&mejs.MediaFeatures.isFullScreen()||a.isFullScreen)&&g.trigger("click")});if(d.media.pluginType==="native"||!d.options.usePluginFullScreen&&!mejs.MediaFeatures.isFirefox)g.click(function(){var k=mejs.MediaFeatures.hasTrueNativeFullScreen&&mejs.MediaFeatures.isFullScreen()||a.isFullScreen;d.container.find("#btnplaypause").focus();if(k){a.exitFullScreen();d.container.parent().find("button.guard").remove()}else{a.enterFullScreen();
...
!mejs.MediaFeatures.isOpera){var i=false,l=function(){if(i){m.hide();o.hide();r.hide();g.css("pointer-events","");d.controls.css("pointer-events","");i=false}},m=f('<div class="mejs-fullscreen-hover" />').appendTo(d.container).mouseover(l),o=f('<div class="mejs-fullscreen-hover"  />').appendTo(d.container).mouseover(l),r=f('<div class="mejs-fullscreen-hover"  />').appendTo(d.container).mouseover(l),t=function(){var k={position:"absolute",top:0,left:0};m.css(k);o.css(k);r.css(k);m.width(d.container.width()).height(d.container.height()-
d.controls.height());k=g.offset().left-d.container.offset().left;fullScreenBtnWidth=g.outerWidth(true);o.width(k).height(d.controls.height()).css({top:d.container.height()-d.controls.height()});r.width(d.container.width()-k-fullScreenBtnWidth).height(d.controls.height()).css({top:d.container.height()-d.controls.height(),left:k+fullScreenBtnWidth})};f(document).resize(function(){t()});g.mouseover(function(){if(!d.isFullScreen){var k=g.offset(),p=a.container.offset();e.positionFullscreenButton(k.left-
p.left,k.top-p.top,false);g.css("pointer-events","none");d.controls.css("pointer-events","none");m.show();r.show();o.show();t();i=true}});e.addEventListener("fullscreenchange",function(){l()})}else g.mouseover(function(){if(j!==null){clearTimeout(j);delete j}var k=g.offset(),p=a.container.offset();e.positionFullscreenButton(k.left-p.left,k.top-p.top,true)}).mouseout(function(){if(j!==null){clearTimeout(j);delete j}j=setTimeout(function(){e.hideFullscreenButton()},1500)})}a.fullscreenBtn=g;f(document).bind("keydown",
