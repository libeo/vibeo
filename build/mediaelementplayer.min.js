...
(function(f){f.extend(mejs.MepDefaults,{playpauseText:"Play/Pause",playText:"Play/Pause",pauseText:"Pause"});f.extend(MediaElementPlayer.prototype,{buildplaypause:function(a,c,b,d){var e=this,g=f('<div class="mejs-button mejs-playpause-button mejs-play" ><button id="btnplaypause" type="button" aria-controlsEnabled="'+e.id+'" aria-live="polite">'+e.options.playText+"</button></div>").appendTo(c).click(function(j){j.preventDefault();d.paused?d.play():d.pause();return false});d.addEventListener("play",
function(){f("#btnplaypause").text(e.options.pauseText);g.removeClass("mejs-play").addClass("mejs-pause")},false);d.addEventListener("playing",function(){f("#btnplaypause").text(e.options.pauseText);g.removeClass("mejs-play").addClass("mejs-pause")},false);d.addEventListener("pause",function(){f("#btnplaypause").text(e.options.playText);g.removeClass("mejs-pause").addClass("mejs-play")},false);d.addEventListener("paused",function(){f("#btnplaypause").text(e.options.playText);g.removeClass("mejs-pause").addClass("mejs-play")},
false)}})})(mejs.$);
