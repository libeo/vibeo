...
"checked")}else{lang=a.captions.attr("lang")||a.options.startLanguage;for(e=0;e<a.tracks.length;e++)if(a.tracks[e].srclang==lang){a.selectedTrack=a.tracks[e];a.captions.attr("lang",a.selectedTrack.srclang);a.displayCaptions();f("#"+a.id+"_captions_"+lang).attr("checked","checked");break}}});a.options.showCaptionPopup&&a.captionsButton.hover(function(){f(this).find(".mejs-captions-selector").css("visibility","visible")},function(){f(this).find(".mejs-captions-selector").css("visibility","hidden")}).delegate("input[type=radio]",
"click",function(){lang=this.value;if(lang=="none")a.selectedTrack=null;else for(e=0;e<a.tracks.length;e++)if(a.tracks[e].srclang==lang){a.selectedTrack=a.tracks[e];a.captions.attr("lang",a.selectedTrack.srclang);a.displayCaptions();break}});if(a.options.alwaysShowControls)a.container.find(".mejs-captions-position").addClass("mejs-captions-position-hover");else{var g;a.container.bind("mouseenter",function(){clearTimeout(g);g=null;a.container.find(".mejs-captions-position").addClass("mejs-captions-position-hover")}).bind("mouseleave",
