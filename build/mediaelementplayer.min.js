...
undefined&&this.media.duration)if(this.total&&this.handle){var a=(this.total.width()-this.handle.outerWidth(true))*this.media.currentTime/this.media.duration;this.current.width(a);this.handle.css("left",a)}}})})(mejs.$);
